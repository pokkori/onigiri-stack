        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 rounded-2xl p-6 w-full max-w-sm text-center border border-amber-500/30">
            <div className="text-5xl mb-2">
              <svg className="w-14 h-14 mx-auto" viewBox="0 0 56 56" fill="none" aria-hidden="true">
                <polygon points="28,6 48,46 8,46" fill="#f59e0b" stroke="#d97706" strokeWidth="2"/>
                <rect x="20" y="26" width="16" height="14" rx="2" fill="#1a0a00" opacity="0.7"/>
                <ellipse cx="28" cy="25" rx="8" ry="5" fill="#fbbf24"/>
              </svg>
            </div>
